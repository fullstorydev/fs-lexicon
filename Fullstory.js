...
class FullstoryConnector extends ConnectorBase {
   ...
   * @param {Object} [params.llm] - Optional. Configuration used to select the LLM model and related prompt and inference options. May include:
   *   @param {string} [params.llm.pre_prompt] - Text to be included in the Generative AI prompt before including the contextual representation of the requested session
   *   @param {string} [params.llm.post_prompt] - Text to be included in the Generative AI prompt after including the contextual representation of the requested session
   *   @param {number} [params.llm.temperature] - Controls the randomness of text generated by a large language model
