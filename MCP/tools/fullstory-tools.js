  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        llm: {
          type: 'object',
          description: 'Configuration used to select the LLM model and related prompt and inference options',
          properties: {
            pre_prompt: { type: 'string', description: 'Text to be included in the Generative AI prompt before including the contextual representation of the requested session' },
            post_prompt: { type: 'string', description: 'Text to be included in the Generative AI prompt after including the contextual representation of the requested session' },
            temperature: { type: 'number', description: 'Controls the randomness of text generated by a large language model' },
            response_schema: { 
              type: 'object', 
              description: 'JSON schema for generating structured response. enforced at LLM, highly reliable',
              properties: {
                type: { type: 'string', enum: ['OPENAPI_TYPE_UNSPECIFIED', 'STRING', 'NUMBER', 'INTEGER', 'BOOLEAN', 'ARRAY', 'OBJECT'], description: 'JSON schema type', default: 'OPENAPI_TYPE_UNSPECIFIED' },
                ...
                format: { type: 'string', description: 'String format specification' }
              }
            }
          }
        },
